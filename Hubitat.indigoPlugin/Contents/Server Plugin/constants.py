...
HE_PROPERTIES_SUPPORTED_BY_DEVICE_TYPES["battery"] = ["button", "contactSensor", "humiditySensor", "illuminanceSensor", "lock", "motionSensor", "multiSensor", "temperatureSensor", "thermostat"]
...
HE_PROPERTIES_SUPPORTED_BY_DEVICE_TYPES["lock"] = ["lock"]
...
HE_PRIMARY_INDIGO_DEVICE_TYPES_AND_HABITAT_PROPERTIES["lock"] = ["lock"]
...
INDIGO_PRIMARY_DEVICE_INFO["lock"] = [indigo.kRelayDeviceSubType.Lock, "Lock"]
...
API_VERSION = 2
PATH = 3
PLUGIN_DISPLAY_NAME = 4
PLUGIN_ID = 5
PLUGIN_INFO = 6
PLUGIN_VERSION = 7
ZWI = 8
ZWAVE_LOGGING = 9
ZWAVE_LOGGING_FOLDER = 10
ZWAVE_LOGGING_FILE_NAME = 11
ZWAVE_LOGGING_MODE = 12
INTERPRETER_CLASS_INSTANCES = 13
ZWAVE_LOG_TO_INDIGO_EVENT_LOG = 14
ZWAVE_LOGGING_AUTO_START = 15
